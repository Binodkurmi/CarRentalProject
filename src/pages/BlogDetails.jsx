              ...
              <div className="comment__list mt-5">
                ...
                <div className="single__comment d-flex gap-3">
                  ...
                  <div className="comment__content">
                    <h6 className=" fw-bold">xyz</h6>
                    <p className="section__description mb-0">14 July, 2024</p>
                    <p className="section__description">
										"The car was in excellent condition and the service was top-notch! I felt safe and comfortable throughout my trip. Highly recommend!"
                    </p>
